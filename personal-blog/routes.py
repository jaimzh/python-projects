...
@router.post("/admin/article/{article_id}/delete")
...
@router.get("/admin/article/new", response_class=HTMLResponse)
...
@router.post("/admin/article/new", response_class=HTMLResponse)
...
@router.get("/admin/article/{article_id}/edit", response_class=HTMLResponse)
...
@router.post("/admin/article/{article_id}/edit")
